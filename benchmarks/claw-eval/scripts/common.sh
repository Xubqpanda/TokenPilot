...
source "${PROJECT_ROOT}/benchmarks/pinchbench/scripts/common.sh"
...
ce_apply_method_profile() {
  ...
  export TOKENPILOT_TASK_STATE_ESTIMATOR_BASE_URL="${TOKENPILOT_TASK_STATE_ESTIMATOR_BASE_URL:-https://api.openai.com/v1}"
